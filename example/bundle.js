...
},{"is-type":6,"react-mixin-classlist":7}],3:[function(require,module,exports){
/**
...
is.defined = function (arg) {
  return typeof arg !== void 0
}
...
is.array = Array.isArray || function (arg) {
  return toString.call(arg) === '[object Array]'
}


is.regexp = is.regExp = function (arg) {
  return toString.call(arg) === '[object RegExp]'
}


is.date = function (arg) {
  return toString.call(arg) === '[object Date]'
}


is.error = function (arg) {
  return toString.call(arg) === '[object Error]' || arg instanceof Error
}
...
is.int = function (arg) {
  return is.number(arg) && arg % 1 === 0
}

is.long = function (arg) {
  return is.int(arg) && (arg >= MAX_INT_31 || arg < -MAX_INT_31)
}

is.double = function (arg) {
  return is.number(arg) && !isNaN(arg) && arg % 1 !== 0
}



// ES6
is.symbol = function (arg) {
  return typeof arg === 'symbol'
}


is.generator = function (arg) {
  return arg && is.function(arg.next) && is.function(arg.throw)
}


is.generatorFunction = function (arg) {
  return arg && arg.constructor && arg.constructor.name === 'GeneratorFunction'
}


is.promise = function (arg) {
...
is.buffer = function (arg) {
  /*
    TODO: add the following condition to prevent browser errors?
    Buffer && is.function(Buffer.isBuffer) && Buffer.isBuffer(arg)
  */
...
is.dom.element = function (arg) {
  return !!(arg && arg.nodeName)
}


is.dom.file = function (arg) {
  return toString.call(arg) === '[object File]'
}


is.dom.window = function (arg) {
  return arg && arg.document && arg.location && arg.alert && arg.setInterval
}
...
is.empty = function (arg) {
  ...
  // case number
  if (is.number(arg)) return arg === 0

  // case array or array like object
  if (is.number(arg.length)) return arg.length === 0

  // case object
  for (var key in arg) if (has.call(arg, key)) return false
